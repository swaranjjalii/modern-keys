...
const ChatbotButton = () => {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleChat}
        className={`fixed bottom-6 right-6 p-4 rounded-full shadow-lg z-50 transition-all duration-300 ${isOpen ? 'bg-white text-navy rotate-90' : 'bg-navy text-white hover:bg-navy-light'
          }`}
